	...
	<form name="Reg_form" action="/grasse/join/joinComplete.do"
		...
		<div class="row">
			<div class="container col-6">
				...
				<div class="header">
					<div class="row">
						<h3 class="text-center col-12 mb-0 font-weight-bold">회원가입</h3>
					</div>
				...
				<div class="body">
					<div class="row py-3">
						<h4 class="text-center col-12 mb-0">기본정보</h4>
						<h6 class="text-center col-12 mb-0">
							<font color="red">*</font>필수입력사항
						</h6>
					</div>

					<div class="form-group row">
						<label class="col-3 col-form-label-sm text-right">아이디<font
							color="red">*</font></label>
						<div class="col-7">
							<input id="MEMBER_ID" name="MEMBER_ID" type="text"
								class="form-control form-control-sm">
							<h6>(영문소문자/숫자, 4~16자)</h6>
					...
					<div class="form-group row">
						<label class="col-3 col-form-label-sm text-right">이름<font
							color="red">*</font></label>
						<div class="col-7">
					...
					<div class="form-group row">
						<label class="col-3 col-form-label-sm text-right">생년월일<font
							color="red">*</font></label>
						<div class="col-7">
							<input id="BIRTH" name="BIRTH" type="text"
								class="form-control form-control-sm" placeholder="ex)19971217">
							<p class="alertBirth alert-positive"></p>
						</div>
					</div>

					<div class="form-group row">
						<label class="col-3 col-form-label-sm text-right">주소<font
							color="red">*</font></label>
						<div class="col-4">
							<input id="ZIPCODE" name="ZIPCODE" type="text"
								class="form-control form-control-sm" placeholder="우편번호">
						</div>
						<div class="col-3">
					...
					<div class="form-group row">
						...
						<div class="col-7 py-1">
							<input id="ADDR1" name="ADDR1" type="text"
								class="form-control form-control-sm" placeholder="기본주소">
						</div>
						<label class="col-3 col-form-label-sm text-right"></label>
						<div class="col-7 py-1">
						...
						<div class="col-7 py-1">
							<input id="EXTRAADDR" name="EXTRAADDR" type="text"
								class="form-control form-control-sm" placeholder="참고항목">
						</div>
					</div>

					<div class="form-group row">
						<label class="col-3 col-form-label-sm text-right">휴대전화<font
							color="red">*</font></label>
						<div class="col-7">
					...
					<div class="form-group row">
						<label class="col-3 col-form-label-sm text-right">이메일<font
							color="red">*</font></label>
						<div class="col-4">
							<input id="EMAIL" name="EMAIL" type="text"
								class="form-control form-control-sm" placeholder="이메일을 입력하세요">
						</div>
						<div class="col-3">
							<button id="emailBtn" name="emailBtn" type="button"
								class="btn btn-secondary btn-sm">인증메일 발송</button>
							<p class="alertEmail alert-positive"></p>
						</div>
					</div>

					<div class="form-group row">
						<label class="col-3 col-form-label-sm text-right">이메일 인증<font
							color="red">*</font></label>
						<div class="col-4">
							<input id="emailAuth" name="emailAuth" type="text"
								class="form-control form-control-sm" placeholder="인증번호 입력">
						</div>
						<div class="col-3">
							<button id="emailAuthBtn" name="emailAuthBtn" type="button"
								class="btn btn-secondary btn-sm">이메일 인증</button>
							<p class="alertEmail alert-positive"></p>
					...
					<!-- 
					<div class="row py-3">
						<h4 class="text-center col-12 mb-0">[필수] 이용약관 동의</h4>
					</div>
 -->
					<div class="이용약관">
						<h4>[필수] 이용약관 동의</h4>
					...
					<div class="input-group form-group row pt-3">
						<div class="col-sm">
							<a href="/grasse/main.do"
								class="btn btn-secondary btn-sm btn-block">회원가입 취소</a>
						</div>
						<div class="col-sm">
							<button class="btn btn-secondary btn-sm btn-block" type="submit">회원가입</button>
						</div>
					</div>

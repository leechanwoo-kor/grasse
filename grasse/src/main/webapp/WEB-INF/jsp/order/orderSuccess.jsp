...
<body>
	<div align="center">
		<form id="frm" align="center">
				...
				<div align="center">
					<p align="center">
						<strong>고객님의 주문이 완료되었습니다.</strong> 주문내역 및 배송에 관한 안내는 <br> <a
							href="/grasse/myPage/orderList">주문조회</a>를 통하여 확인가능합니다.
					</p>
						...
						<tbody align="center">
							<tr align="center">
								...
								<td class="price"><strong><fmt:formatNumber
											value="${orderInfo.TOTALPRICE }" pattern="#,###" />원</strong></td>
							</tr>
							<tr>
			...
			<!-- 추가정보 -->
			<div>
				<span> <a href="/grasse/main.do">쇼핑계속하기</a> <a
					href="/grasse/myPage/orderList">주문확인하기</a>
				</span>
			</div>
			<!-- 이용안내 -->
			<div>
				<h3>이용안내</h3>
				<div>
					<br />비회원 주문의 경우, 주문번호를 꼭 기억하세요. 주문번호로 주문조회가 가능합니다. <br />배송은

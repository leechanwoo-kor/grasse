			...
			<div class="col-lg-4 border border-light rounded" style="flex-align: center">
				...
				<div class="jumbotron" style="padding-top: 20px;">
					...
					<form name="loginForm" action="login.do" method="post"
						...
						<h3 class="py-3 font-weight-bold" style="text-align: center;">로그인</h3>
						...
						<button type="submit"
							class="btn btn-warning form-control text-light">로그인</button>

						<div class="check box form-group py-3">
							<input type="checkbox" id="idSave" value="T" name="idSave"
								style="font-size: 10px">아이디 저장 <input type="checkbox"
								id="autoLogin" value="T" name="autoLogin"
								style="font-size: 10px">자동 로그인
						</div>


						<div class="form-group">
							<p>회원이 되시면 다양한 혜택이있습니다.</p>
							<p>아직 회원이 아니시라면 지금 바로 가입하세요.</p>
						</div>


						<div class="row">
							<div class="col-sm-6">
								<a href="findId.do" class="btn btn-warning btn-sm btn-block">아이디
									찾기</a>
							</div>
							<div class="col-sm-6">
								<a href="findPw.do" class="btn btn-warning btn-sm btn-block">비밀번호
									찾기</a>
							</div>
						</div>

...
public class RSAKeySet {
	...
	public RSAKeySet(String encodedPublic, String encodedPrivate) throws Exception {
		...
		publicKey = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(decoder.decode(encodedPublic)));
		privateKey = KeyFactory.getInstance("RSA")
				.generatePublic(new X509EncodedKeySpec(decoder.decode(encodedPrivate)));
	...
	private void setPublicKeySpec() throws Exception {
		RSAPublicKeySpec publicSpec = (RSAPublicKeySpec) KeyFactory.getInstance("RSA").getKeySpec(publicKey,
